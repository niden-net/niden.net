...
Although I have heard of the name, I was not following very closely the development of the said OS, so I did not know what to expect. The [presentation on Day 2 at Google I/O](https://youtu.be/IY3U2GXhz44) was more than impressive, so I had to get my hands on it :)
...
![Froyo](/assets/files/2010-06-21-froyo.png)
...
![Reboot](/assets/files/2010-06-21-reboot3.png)
...
![Reboot](/assets/files/2010-06-21-reboot1.png)
...
![Recovery](/assets/files/2010-06-21-recovery2.png)
...
![Search Phone](/assets/files/2010-06-21-search-phone.png)
![Search Areas](/assets/files/2010-06-21-search-areas.png)
...
![Hotspot](/assets/files/2010-06-21-hotspot-on.png)
...
![Hotspot](/assets/files/2010-06-21-configure-hotspot.png)
...
![Hotspot Settings](/assets/files/2010-06-21-hotspot-settings.png)
...
![Main Screen](/assets/files/2010-06-21-mainscreen.png)
...
![Sync Accounts](/assets/files/2010-06-21-syncaccounts.png)
...
![Email Account](/assets/files/2010-06-21-emailaccountselection1.png)
...
![Labels](/assets/files/2010-06-21-coloredlabels.png)
...
![Email Left Right](/assets/files/2010-06-21-emailleftrightbuttons.png)
...
![Upload All](/assets/files/2010-06-21-uploadall.png)
...
These I loved them the first time I saw them. If  USB debugging is enabled  (_Settings - Applications - Development - USB Debugging_), the minute the phone is connected to the computer using the USB cable, a new icon will appear in the notification area (Figure 15). It appears that it is an android bug of sorts :)

![USB Icon](/assets/files/2010-06-21-usbdebuggingicon.png)
![USB On](/assets/files/2010-06-21-usbon.png)
![USB Off](/assets/files/2010-06-21-usboff.png)
...
![Camera](/assets/files/2010-06-21-camera-controls.png)
...
![Select Text](/assets/files/2010-06-21-selecttext.png)
...
![Select Text](/assets/files/2010-06-21-select-text-1.png)
...
![Pacman](/assets/files/2010-06-21-pacman.png)
